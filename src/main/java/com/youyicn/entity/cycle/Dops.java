...
public class Dops  implements Serializable{

	/**
	 * 
	 */
	private static final long serialVersionUID = -6386335540341966551L;
	/**
	 * 
	 */
	...
	public String getKgIdentity() {
		return kgIdentity;
	}
	public void setKgIdentity(String kgIdentity) {
		this.kgIdentity = kgIdentity;
	}
